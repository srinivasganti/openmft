defmodule Openmft.Ui.Dsl.Verifiers.DataTable.DefaultSortsValid do
  @moduledoc """
  Ensures all actions have a valid default sort, when specified.
  """
